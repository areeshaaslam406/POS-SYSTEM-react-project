...
const SalespersonTable = ({ salespersons, onEdit, onDelete }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-slate-200/50">
      ...
      {/* Table Header */}
      <div className="bg-gradient-to-r from-slate-100 to-indigo-100 border-b border-slate-200">
        <div className="grid grid-cols-5 gap-4 px-6 py-4 text-sm font-semibold text-slate-700">
          <button
